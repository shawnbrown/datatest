...
class TestLoadCsv(unittest.TestCase):
    ...
    def test_encoding_with_stream(self):
        ...
        _load_csv(self.cursor, 'testtable1', csvfile, encoding='latin-1')
    ...
    def test_encoding_with_file(self):
        ...
        _load_csv(self.cursor, 'testtable', path, encoding='latin-1')
    ...
    def test_encoding_mismatch(self):
        ...
        with self.assertRaises(UnicodeDecodeError):
            _load_csv(self.cursor, 'testtable', path, wrong_encoding)
    ...
    def test_fallback_with_stream(self):
        with warnings.catch_warnings(record=True):  # Catch warnings issued
            ...
            _load_csv(self.cursor, 'testtable1', csvfile)  # <- No encoding arg.
    ...
    def test_fallback_with_file(self):
        with warnings.catch_warnings(record=True) as warning_list:
            ...
            path = 'sample_text_iso88591.csv'
            _load_csv(self.cursor, 'testtable', path)  # <- No encoding arg.
    ...
    def test_fallback_with_exhaustible_object(self):
        ...
        with self.assertRaises(UnicodeDecodeError) as cm:
            _load_csv(self.cursor, 'testtable', generator)
