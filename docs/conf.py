...
intersphinx_mapping = {
    ...
    'squint': ('https://squint.readthedocs.io/en/stable/', None),
...
rst_prolog = """
.. |releasebadge| image:: https://img.shields.io/badge/this_version-{version}-yellow?logo=git&logoColor=white&style=flat-square
    :alt: Full Version
